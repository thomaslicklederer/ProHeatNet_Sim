...
self.scenario[1]['T_sec_in_degree']     =   45  # [°C]
self.scenario[1]['T_sec_in']            =   self.scenario[1]['T_sec_in_degree'] + 273.15 # [K]
self.scenario[1]['dotV_sec_in']         =   15 # [l / min]
self.scenario[1]['kappa']               =   0.9
self.scenario[1]['u']                   =   0
...
self.scenario[2]['dotV_sec_in']         =   -20 # [l/min]
self.scenario[2]['kappa']               =   0
self.scenario[2]['u']                   =   0.9
